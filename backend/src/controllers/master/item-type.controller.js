...
async function store(req, res, next) {
  try {
    const result = await ItemTypeService.store(req.body, req.user.id, req);
...
async function update(req, res, next) {
  try {
    const result = await ItemTypeService.update(req.params.id, req.body, req.user.id, req);
...
async function destroy(req, res, next) {
  try {
    const result = await ItemTypeService.destroy(req.params.id, req.user.id, req);
...
async function toggleStatus(req, res, next) {
  try {
    const result = await ItemTypeService.updateStatus(
      req.params.id,
      req.body.is_active,
      req.user.id,
      req

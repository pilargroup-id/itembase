...
const upload=multer({storage:multer.memoryStorage(),limits:{fileSize:15*1024*1024},fileFilter:(_req,file,cb)=>cb(null,/\.xlsx$/i.test(file.originalname))});
router.use(authenticate,requireApp('itembase'));
router.get('/exports/:type',controller.exportData);

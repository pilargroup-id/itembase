...
function DialogExportItemContent({
  ...
  const columnMenuId = 'export-item-column-menu'
...
function DialogExportItem({
  ...
  return <DialogExportItemContent eyebrow={eyebrow} title={title} onClose={onClose} />
}

export default DialogExportItem

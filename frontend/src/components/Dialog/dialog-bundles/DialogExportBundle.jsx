...
function DialogExportBundleContent({
...
function DialogExportBundle({
  ...
  return <DialogExportBundleContent eyebrow={eyebrow} title={title} onClose={onClose} />
}

export default DialogExportBundle
  ...
  const dialogNode = (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-delete-uom-title"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="dashboard-popup__header">
          <div>
            <p className="dashboard-popup__eyebrow">{eyebrow}</p>
            <h2 className="dashboard-popup__title" id="dialog-delete-uom-title">
              {title}
            </h2>
          </div>
...
export default DialogDeleteUom

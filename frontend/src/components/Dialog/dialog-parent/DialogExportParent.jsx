...
const optionalFields = [
  ...
  { key: 'pic', label: 'PIC' },
  { key: 'parent_created_date', label: 'Parent Created Date' },
  { key: 'parent_updated_date', label: 'Parent Updated Date' },
  { key: 'parent_status_date', label: 'Parent Status Date' },
  { key: 'port', label: 'Port' },
...
function DialogExportParentContent({
  ...
  const columnMenuId = 'export-parent-column-menu'
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const blob = await api.itemData.exportParents(params)
...
function DialogExportParent({
  ...
  return <DialogExportParentContent eyebrow={eyebrow} title={title} onClose={onClose} />
}

export default DialogExportParent

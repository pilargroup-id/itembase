...
function DialogCreateSkuStatus({
  isOpen = false,
  eyebrow = 'Create SKU Status',
  title = 'Create SKU Status',
  onClose,
  onCreated,
}) {
  ...
  const dialogNode = (
    ...
    >
      <form
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-sku-status-title"
      ...
      >
        <div className="dashboard-popup__header">
          <div>
            ...
            <h2 className="dashboard-popup__title" id="dialog-create-sku-status-title">
              {title}
            </h2>
          </div>
...
export default DialogCreateSkuStatus

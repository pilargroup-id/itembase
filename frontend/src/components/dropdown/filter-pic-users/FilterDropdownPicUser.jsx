...
function FilterDropdownPicUser({
    options = [],
    value = "all",
    label = "Pic User",
    placeholder = "Semua Pic User",
    searchPlaceholder = "Cari Pic User...",
    emptyMessage = "Pic User tidak ditemukan.",
    className = "",
    searchable = true,
    onChange,
}) {
    ...
    return (
        <div
            ref={rootRef}
            className={["year-dropdown-tp", "pic-user-filter-dropdown", className]
                .filter(Boolean)
                .join(" ")}
        >
            <button
            ...
            {isOpen ? (
                <div className="year-dropdown-tp__menu" role="listbox" aria-label={label}>
                    {searchable ? (
                        <div className="pic-user-filter-dropdown__search-shell">
                            <input
                                ref={searchInputRef}
                                type="search"
                                className="pic-user-filter-dropdown__search-input"
                                value={searchQuery}
                    ...
                    <div className="pic-user-filter-dropdown__options">
                        {filteredOptions.length > 0 ? (
                            ...
                            <div className="pic-user-filter-dropdown__empty">{emptyMessage}</div>
                        )}
                    </div>
                </div>
            ) : null}
...
export default FilterDropdownPicUser

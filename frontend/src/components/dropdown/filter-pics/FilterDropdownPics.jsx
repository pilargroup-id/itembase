...
function FilterDropdownPics({
    options = [],
    value = "all",
    label = "Pics",
    placeholder = "Semua Pics",
    searchPlaceholder = "Cari pics...",
    emptyMessage = "Pics tidak ditemukan.",
    className = "",
    searchable = true,
    onChange,
}) {
    ...
    return (
        <div
            ref={rootRef}
            className={["year-dropdown-tp", "pics-filter-dropdown", className]
                .filter(Boolean)
                .join(" ")}
        >
            <button
            ...
            {isOpen ? (
                <div className="year-dropdown-tp__menu" role="listbox" aria-label={label}>
                    {searchable ? (
                        <div className="pics-filter-dropdown__search-shell">
                            <input
                                ref={searchInputRef}
                                type="search"
                                className="pics-filter-dropdown__search-input"
                                value={searchQuery}
                    ...
                    <div className="pics-filter-dropdown__options">
                        {filteredOptions.length > 0 ? (
                            ...
                            <div className="pics-filter-dropdown__empty">{emptyMessage}</div>
                        )}
                    </div>
                </div>
            ) : null}
...
export default FilterDropdownPics

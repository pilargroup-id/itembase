...
function FilterDropdownPort({
    options = [],
    value = "all",
    label = "Port",
    placeholder = "Semua Port",
    ...
    return (
        <div
            ref={rootRef}
            className={["year-dropdown-tp", "Type-filter-dropdown", className]
                .filter(Boolean)
                .join(" ")}
        >
            <button
            ...
            {isOpen ? (
                <div className="year-dropdown-tp__menu" role="listbox" aria-label={label}>
                    {searchable ? (
                        <div className="Type-filter-dropdown__search-shell">
                            <input
                                ref={searchInputRef}
                                type="search"
                    ...
                    <div className="Type-filter-dropdown__options">
                        {filteredOptions.length > 0 ? (
                            ...
                            <div className="Type-filter-dropdown__empty">{emptyMessage}</div>
                        )}
                    </div>
                </div>
            ) : null}
...
export default FilterDropdownPort

...
function FilterDropdownSkuStatus({
    options = [],
    value = "all",
    label = "Sku Status",
    placeholder = "Semua Sku Status",
    ...
    return (
        <div
            ref={rootRef}
            className={["year-dropdown-tp", "sku-status-filter-dropdown", className]
                .filter(Boolean)
                .join(" ")}
        >
            <button
            ...
            {isOpen ? (
                <div className="year-dropdown-tp__menu" role="listbox" aria-label={label}>
                    {searchable ? (
                        <div className="sku-status-filter-dropdown__search-shell">
                            <input
                                ref={searchInputRef}
                                type="search"
                                className="sku-status-filter-dropdown__search-input"
                                value={searchQuery}
                    ...
                    <div className="sku-status-filter-dropdown__options">
                        {filteredOptions.length > 0 ? (
                            ...
                            <div className="sku-status-filter-dropdown__empty">{emptyMessage}</div>
                        )}
                    </div>
                </div>
            ) : null}
...
export default FilterDropdownSkuStatus

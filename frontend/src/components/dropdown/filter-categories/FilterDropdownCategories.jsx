...
function FilterDropdownCategories({
    options = [],
    value = "all",
    label = "Categories",
    placeholder = "Semua Categories",
    searchPlaceholder = "Cari categories...",
    emptyMessage = "Categories tidak ditemukan.",
    className = "",
    searchable = true,
    onChange,
}) {
    ...
    return (
        <div
            ref={rootRef}
            className={["year-dropdown-tp", "categories-filter-dropdown", className]
                .filter(Boolean)
                .join(" ")}
        >
            <button
            ...
            {isOpen ? (
                <div className="year-dropdown-tp__menu" role="listbox" aria-label={label}>
                    {searchable ? (
                        <div className="categories-filter-dropdown__search-shell">
                            <input
                                ref={searchInputRef}
                                type="search"
                                className="categories-filter-dropdown__search-input"
                                value={searchQuery}
                    ...
                    <div className="categories-filter-dropdown__options">
                        {filteredOptions.length > 0 ? (
                            ...
                            <div className="categories-filter-dropdown__empty">{emptyMessage}</div>
                        )}
                    </div>
                </div>
            ) : null}
...
export default FilterDropdownCategories

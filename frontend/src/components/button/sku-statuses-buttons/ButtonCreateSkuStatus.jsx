...
function ButtonCreateSkuStatus({
  ...
  const handleCreated = (createdSkuStatus) => {
    dialogProps.onCreated?.(createdSkuStatus)
...
export default ButtonCreateSkuStatus

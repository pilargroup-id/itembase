...
export function Download01(props) {
  return (
    <IconBase {...props}>
...
export function Export01(props) {
  return (
    <IconBase {...props}>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
      <path d="M15 3h6v6" />
...
export function Upload01(props) {
  return (
    <IconBase {...props}>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
...
export function UserCog(props) {
  return (
    <IconBase {...props}>
      ...
      <path d="M19 8v1" />
      <path d="M19 13v1" />
      <path d="m16.6 9.5-.87.5" />
      <path d="m22.27 12-.87.5" />
      <path d="m16.6 12.5-.87-.5" />
      <path d="m22.27 10-.87-.5" />
    </IconBase>
  )
}
